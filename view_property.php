...
<section class="view-property">
   ...
   <?php
      $select_properties = $conn->prepare("SELECT * FROM `property` WHERE id = ? AND (approval_status = 'approved' OR user_id = ?) ORDER BY date DESC LIMIT 1");
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-user"></i><span><?= ($fetch_user) ? $fetch_user['name'] : 'Unknown User'; ?></span></p>
         <p><i class="fas fa-phone"></i><a href="tel:1234567890"><?= ($fetch_user) ? $fetch_user['number'] : 'N/A'; ?></a></p>
